...
def run():
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            li=['sphinx','windows','ubuntu','datastructures','swift','objective-c','xcode','rest','soap','cocoatouch','plist','sqlite','maple','c','htcondor','datamining','mathematica','cpp','c++','java','html','python','css','javascript','django','mysql','spark','artificial intelligence','ruby','kotlin','ai','machinelearning','cvs','deep learning','dataanalysis','neural networking','react', 'django', 'node jS', 'react js', 'php','latex','git', 'laravel', 'magento', 'wordpress','javascript', 'angular js', 'c#', 'flask','android','android development','flutter','kotlin','xml','kivy','ios','ios development','swift','cocoa','cocoa touch','xcode','matlab','r','cisco networking']
            ...
            keywords = st_tags(label='### Skills that you have',
                text='See our skills recommendation',
                    value=lis3,key = '1')
            ds_keyword = ['tensorflow','keras','pytorch','machinelearning','deep Learning','flask','streamlit','artificial intelligence']
            web_keyword = ['react', 'django', 'node jS', 'react js', 'php', 'laravel', 'magento', 'wordpress','html','css','c','java',
                               'javascript', 'angular js', 'c#', 'flask']
            android_keyword = ['android','android development','flutter','kotlin','xml','kivy','cpp','python']
            ios_keyword = ['ios','ios development','swift','cocoa','cocoatouch','xcode','soap']
            ...
            for i in lis3:
                    ...
                    if i.lower() in ds_keyword:
                        ...
                        recommended_skills = ['Data Visualization','Predictive Analysis','Statistical Modeling','DataMining','Clustering & Classification','Data Analytics','Quantitative Analysis','Web Scraping','ML Algorithms','Keras','Pytorch','Probability','Scikit-learn','Tensorflow',"Flask",'Streamlit']
                        lis4=[value for value in lis3 if value in ds_keyword]
                        k=len(lis4)
                        k=k/len(ds_keyword)*100
                        lis5 = [value for value in recommended_skills if value.lower() not in lis3]
                        recommended_skills=lis5
                    ...
                    ## Android App Development
                        ...
                        recommended_skills = ['Android','Androiddevelopment','Flutter','Kotlin','XML','Java','Kivy','GIT','SDK','SQLite']
                        lis5 = [value for value in recommended_skills if value.lower() not in lis3]
                        recommended_skills=lis5
                        lis4=[value for value in lis3 if value in android_keyword]
                        k=len(lis4)
                        k=k/len(android_keyword)*100
                        recommended_keywords = st_tags(label='### Recommended skills for you.',
                        ...
                        recommended_skills = ['IOS','IOSDevelopment','Swift','Cocoa','CocoaTouch','Xcode','Objective-C','SQLite','Plist','StoreKit',"UI-Kit",'AV Foundation','Auto-Layout']
                        lis5 = [value for value in recommended_skills if value.lower() not in lis3]
                        recommended_skills=lis5
                        lis4=[value for value in lis3 if value in ios_keyword]
                        k=len(lis4)
                        k=k/len(ios_keyword)*100
                        recommended_keywords = st_tags(label='### Recommended skills for you.',
                        ...
                        lis5 = [value for value in recommended_skills if value.lower() not in lis3]
                        recommended_skills=lis5
                        lis4=[value for value in lis3 if value in web_keyword]
                        k=len(lis4)
                        k=k/len(web_keyword)*100
                        recommended_keywords = st_tags(label='### Recommended skills for you.',
                        text='Recommended skills generated from System',value=recommended_skills,key = '5')
                        st.markdown('''<h4 style='text-align: left; color: #1ed760;'>Adding this skills to resume will boost🚀 the chances of getting a Job💼</h4>''',unsafe_allow_html=True)
                    ...
                    ## Ui-UX Recommendation
                        ...
                        lis5 = [value for value in recommended_skills if value.lower() not in lis3]
                        recommended_skills=lis5
                        lis4=[value for value in lis3 if value in uiux_keyword]
                        k=len(lis4)
                        k=k/len(uiux_keyword)*100
                        recommended_keywords = st_tags(label='### Recommended skills for you.',
            ...
            score = 0
            for percent_complete in range(int(k)):
                    score +=1
                    time.sleep(0.1)
                    my_bar.progress(percent_complete + 1)
            st.success('** Your Resume Writing Score: ' + str(k)+'**')
